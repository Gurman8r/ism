...
namespace ism
{
	struct Vec3
	{
		...
		using storage_type				= typename Array<float_t, 3>;
		...
		constexpr Vec3(storage_type && value) noexcept : m_data{ std::move(value) } {}

		constexpr Vec3(Vec3 const & other) : m_data{ other.m_data } {}
		
		constexpr Vec3(Vec3 && other) noexcept : m_data{} { this->swap(std::move(other)); }
		...
		constexpr void swap(Vec3 & other) noexcept
		{
...
#ifdef ISM_VECTOR3_EXTRA
		ISM_VECTOR3_EXTRA
#endif // ISM_VECTOR3_EXTRA
