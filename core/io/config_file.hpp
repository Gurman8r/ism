...
namespace ism
{
	...
	public:
		...
		NODISCARD f64 get_double(String const & section, String const & name, f64 dv = {}) const;
		
		NODISCARD f32 get_float(String const & section, String const & name, f32 dv = {}) const;
		
		NODISCARD i32 get_int(String const & section, String const & name, i32 dv = {}) const;
		
		NODISCARD u32 get_uint(String const & section, String const & name, u32 dv = {}) const;
