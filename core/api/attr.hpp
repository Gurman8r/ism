...
namespace ism::api
{
	...
	template <class T> struct process_attribute_default
	{
		...
		static void postcall(function_call &, OBJ) {}
	};
	...
	{
		static void init(function_record & r, name && a) noexcept { r.name = a.value; }
	};

	// return policy
	template <> struct process_attribute<ReturnPolicy_> : process_attribute_default<ReturnPolicy_>
	{
		static void init(function_record & r, ReturnPolicy_ && a) noexcept { r.policy = a; }
	};
	...
	{
		static void init(function_record & r, sibling && a) noexcept { r.sibling = a.value; }
	};
	...
	{
		static void init(function_record & r, is_method && a) noexcept { r.is_method = true; r.scope = a.value; }
	};
	...
	{
		static void init(function_record & r, scope && a) noexcept { r.scope = a.value; }
	};
	...
	{
		static void init(function_record & r, is_operator && a) noexcept { r.is_operator = true; }
	};
	...
	{
		static void init(function_record & r, is_constructor && a) noexcept { r.is_constructor = true; }
	};
...
namespace ism::api
{
	...
	template <class ... Args> struct process_attributes
	{
		...
		static void postcall(function_call & call, OBJ retv)
		{
