...
namespace ism::api
{
	...
	protected:
		void initialize(TypeObject & t)
		{
		}

		void def_property_static_impl(cstring name, OBJECT fget, OBJECT fset, function_record * rec_func)
		{
...
namespace ism::api
{
	...
	{
		ISM_HANDLE_DEFAULT(GenericObject);
