...
namespace Ism
{
	...
	public:
		...
		virtual String get_cache_path() const noexcept override;
		virtual String get_config_path() const noexcept override;
		virtual String get_data_path() const noexcept override;
		virtual String get_exec_path() const noexcept override;
		virtual String get_resource_path() const noexcept override;
		virtual String get_system_path(SystemDir_ value) const noexcept override;
		virtual String get_user_path() const noexcept override;
