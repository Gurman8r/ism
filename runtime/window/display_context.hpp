#ifndef _ISM_DISPLAY_CONTEXT_HPP_
#define _ISM_DISPLAY_CONTEXT_HPP_
...
namespace ism
{
	...
	// display server
	class ISM_API DisplayContext : public Object
	{
		OBJECT_COMMON(DisplayContext, Object);

		static DisplayContext * singleton;

	protected:
		explicit DisplayContext() noexcept : Object{} { singleton = this; }
	...
	public:
		...
		NODISCARD virtual WindowCharCallback window_get_char_callback(WindowID id) const;
		NODISCARD virtual WindowCharModsCallback window_get_char_mods_callback(WindowID id) const;
		NODISCARD virtual WindowCloseCallback window_get_close_callback(WindowID id) const;
		NODISCARD virtual WindowContentCallback window_get_content_scale_callback(WindowID id) const;
		NODISCARD virtual WindowDropCallback window_get_drop_callback(WindowID id) const;
		NODISCARD virtual WindowFocusCallback window_get_focus_callback(WindowID id) const;
		NODISCARD virtual WindowFramebufferResizeCallback window_get_framebuffer_resize_callback(WindowID id) const;
		NODISCARD virtual WindowIconifyCallback window_get_iconify_callback(WindowID id) const;
		NODISCARD virtual WindowKeyCallback window_get_key_callback(WindowID id) const;
		NODISCARD virtual WindowMaximizeCallback window_get_maximize_callback(WindowID id) const;
		NODISCARD virtual WindowMouseButtonCallback window_get_mouse_button_callback(WindowID id) const;
		NODISCARD virtual WindowMouseEnterCallback window_get_mouse_enter_callback(WindowID id) const;
		NODISCARD virtual WindowMousePosCallback window_get_mouse_pos_callback(WindowID id) const;
		NODISCARD virtual WindowPositionCallback window_get_position_callback(WindowID id) const;
		NODISCARD virtual WindowRefreshCallback window_get_refresh_callback(WindowID id) const;
		NODISCARD virtual WindowResizeCallback window_get_resize_callback(WindowID id) const;
		NODISCARD virtual WindowMouseScrollCallback window_get_scroll_callback(WindowID id) const;
...
#endif // !_ISM_DISPLAY_CONTEXT_HPP_
