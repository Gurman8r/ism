...
filter{ "configurations:Debug" }
	prebuildcommands{
		COPYFILE("%{wks.location}misc/%{_TARGET_OS}/%{cfg.platform}/%{cfg.buildcfg}/python39_d%{DLL}", "%{wks.location}bin/%{cfg.platform}/%{cfg.buildcfg}/"),
	}
	
filter{ "configurations:Release" }
	prebuildcommands{
		COPYFILE("%{wks.location}misc/%{_TARGET_OS}/%{cfg.platform}/%{cfg.buildcfg}/python39%{DLL}", "%{wks.location}bin/%{cfg.platform}/%{cfg.buildcfg}/"),
	}
