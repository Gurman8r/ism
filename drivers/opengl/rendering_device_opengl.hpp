...
namespace ism
{
	...
	public:
		...
		virtual void shader_set_uniform2f(RID rid, cstring name, Vec2f const & value) override;
		virtual void shader_set_uniform3f(RID rid, cstring name, Vec3f const & value) override;
		virtual void shader_set_uniform4f(RID rid, cstring name, Vec4f const & value) override;
		virtual void shader_set_uniform16f(RID rid, cstring name, Mat4f const & value, bool transpose = false) override;
