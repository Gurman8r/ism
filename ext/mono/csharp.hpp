...
namespace Ism
{
	...
	// csharp language
	class ISM_MOD_API CSharpLanguage : public ScriptLanguage
	{
	...
	// csharp script
	class ISM_MOD_API CSharpScript : public Script
	{
	...
	// csharp instance
	class ISM_MOD_API CSharpInstance : public ScriptInstance
	{
	...
	class ISM_MOD_API CSharpScriptFormatLoader : public ResourceFormatLoader {
