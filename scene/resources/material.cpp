...
namespace Ism
{
	...
	RS::ShaderMode_ ShaderMaterial::get_shader_mode() const { return m_shader->get_mode(); }
	...
	RS::ShaderMode_ StandardMaterial3D::get_shader_mode() const
	{
		return RS::ShaderMode_MAX;
	}
