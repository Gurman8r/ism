...
includedirs{
	...
	"%{wks.location}/thirdparty/pybind11/include",
	"%{wks.location}/thirdparty/cpython/Include",
	"%{wks.location}/thirdparty/cpython/Include/internal",
	"%{wks.location}/thirdparty/cpython/PC",
